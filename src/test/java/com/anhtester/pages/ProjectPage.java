...
public class ProjectPage extends CommonPage {
    ...
    {
        WebUI.assertTrue(WebUI.checkElementExist(titleProjectPage), "The ProjectPage title not display.");
    ...
    {
        WebUI.assertTrue(WebUI.checkElementExist(alertsuccess), "The alertsuccess title not display.");
        WebUI.assertEquals(WebUI.getTextElement(alertsuccess), "Project added successfully.", "The alertsuccess title not match.");
        WebUI.assertTrue(WebUI.checkElementExist(projectNameCustomer), "The project customer header page not display.");
        ...
        WebUI.assertTrue(WebUI.checkElementExist(projectProgress), "The project progress not display.");
        WebUI.assertEquals(WebUI.getTextElement(projectProgress), "Project Progress 50%", "The project progress not match.");
        WebUI.assertTrue(WebUI.checkElementExist(customer), "The customer title not display.");
        WebUI.assertEquals(WebUI.getTextElement(customer), "Customer", "The customer title not match.");
        WebUI.assertTrue(WebUI.checkElementExist(projectNameCreated), "The project name not display.");
        WebUI.assertEquals(WebUI.getTextElement(projectNameCreated), "Bin Customer", "The project progress not match.");
        WebUI.assertTrue(WebUI.checkElementExist(status), "The status title not display.");
        WebUI.assertEquals(WebUI.getTextElement(status), "Status", "The status title not match.");
        WebUI.assertTrue(WebUI.checkElementExist(statusProject), "The statusProject title not display.");
    ...
    public void searchAndCheckCustomerInTable(String customerName)
    {
        ...
        WebUI.assertEquals(WebUI.getTextElement(itemCustomerFirst), customerName, "The customer name in table not match");
    }
    ...
    {
        WebUI.assertTrue(WebUI.checkElementExist(projectNameOnProjectTab), "The Project Name not display.");
        WebUI.assertEquals(WebUI.getTextElement(projectNameOnProjectTab), "Bin Project", "The Project Name not match.");
        WebUI.assertTrue(WebUI.checkElementExist(statusOnProjectTab), "The status not display.");
    ...
    {
        WebUI.assertTrue(WebUI.checkElementExist(noData), "The nodata text not display.");
