...
public class CustomerPage extends CommonPage {
        ...
        public void searchAndCheckDataInTable(int column, String customerName, String columnName)
        {
            ...
            WebUI.checkDataInTableByColumn_Contains(3, customerName, "Company");
        }
        ...
        public void verifyCustomerAdded()
        {
            ...
            WebUI.assertTrue(WebUI.checkElementDisplayed(inputCompany), "Company field not displayed");
            WebUI.assertEquals(WebUI.getAttributeElement(inputCompany, "value"), "Nashtech Company", "Company name not matched");
            WebUI.assertTrue(WebUI.checkElementDisplayed(inputVATNumber), "VAT number field not displayed");
            WebUI.assertEquals(WebUI.getAttributeElement(inputVATNumber, "value"), "123456789", "VAT number not matched");
            WebUI.assertTrue(WebUI.checkElementDisplayed(inputPhoneNumber), "Phone Number field not displayed");
            WebUI.assertEquals(WebUI.getAttributeElement(inputPhoneNumber, "value"), "0123456789", "PhoneNumber not matched");
            WebUI.assertTrue(WebUI.checkElementDisplayed(inputWebsite), "Website field not displayed");
            WebUI.assertEquals(WebUI.getAttributeElement(inputWebsite, "value"), "https://nashtech.com.vn", "Website not matched");
            WebUI.assertTrue(WebUI.checkElementDisplayed(dropDownGroups), "Groups field not displayed");
            WebUI.assertEquals(WebUI.getTextElement(dropDownGroups), "VIP", "Groups not matched");
            WebUI.assertTrue(WebUI.checkElementDisplayed(currencyDropdown), "Currency field not displayed");
            WebUI.assertEquals(WebUI.getTextElement(currencyDropdown), "EUR", "Currency not matched");
            WebUI.assertTrue(WebUI.checkElementDisplayed(defaultLanguageDropdown), "Default Language field not displayed");
            WebUI.assertEquals(WebUI.getTextElement(defaultLanguageDropdown), "Vietnamese", "Default Language not matched");
            WebUI.assertTrue(WebUI.checkElementDisplayed(inputAddress), "Address field not displayed");
            WebUI.assertEquals(WebUI.getAttributeElement(inputAddress, "value"), "123 Street, Hanoi", "Address not matched");
            WebUI.assertTrue(WebUI.checkElementDisplayed(inputCity), "City field not displayed");
            WebUI.assertEquals(WebUI.getAttributeElement(inputCity, "value"), "Hanoi", "City name not matched");
            WebUI.assertTrue(WebUI.checkElementDisplayed(inputState), "State field not displayed");
            WebUI.assertEquals(WebUI.getAttributeElement(inputState, "value"), "Hoan Kiem", "State name not matched");
            WebUI.assertTrue(WebUI.checkElementDisplayed(inputZipCode), "Zip code field not displayed");
            WebUI.assertEquals(WebUI.getAttributeElement(inputZipCode, "value"), "100000", "Zip code not matched");
            WebUI.assertTrue(WebUI.checkElementDisplayed(countryDropdown), "Country field not displayed");
            WebUI.assertEquals(WebUI.getTextElement(countryDropdown), "Vietnam", "Country name not matched");
        }
        ...
        public void searchCustomer(String customerName)
        {
            ...
            WebUI.assertTrue(WebUI.checkElementDisplayed(dataInTable), "Customer not found: " + customerName);
        }
