...
public class ApiKeyword {
    ...
    @Step("GET: {0} with body by File {1}")
    public static Response get(String path, File fileBody) {
        LogUtils.info("GET: " + path);
    ...
    @Step("GET: {0} with body key {1} from file {2}")
    public static Response get(String path, String key, File fileBody) {
        JsonPath jsonPath = new JsonPath(fileBody);
    ...
    @Step("POST: {0} with field {1} and file {2}")
    public static Response post(String endpoint, String fieldName, File file) {
        return given(SpecBuilder.getRequestMultipartSpecBuilder())
    ...
    @Step("DELETE: {0} with body key {1} from file {2}")
    public static Response delete(String path, String key, File fileBody) {
        JsonPath jsonPath = new JsonPath(fileBody);
        String value = jsonPath.getString(key);
